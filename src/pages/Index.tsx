...
const Index = () => {
  ...
  const teamMembers = [
    {
      name: 'Александр Тигров',
      role: 'Основатель и тренер',
      achievement: 'Мастер спорта по бегу'
    },
    {
      name: 'Мария Леопардова',
      role: 'Главный тренер',
      achievement: 'КМС, призёр чемпионата России'
    },
    {
      name: 'Дмитрий Гепардов',
      role: 'Тренер по спринту',
      achievement: 'Рекордсмен города'
    }
  ];
